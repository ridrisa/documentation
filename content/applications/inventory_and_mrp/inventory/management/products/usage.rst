...
expedites order fulfillment by allowing the immediate shipment of available items, while awaiting the
rest.
...
.. important::
   To see the :guilabel:`Reserve Packaging` field, the :guilabel:`Product Packaging` feature must be
   enabled by going to :menuselection:`Inventory app --> Configuration --> Settings`, scrolling to
   the :guilabel:`Products` section, and ticking the :guilabel:`Product Packagings` checkbox.
